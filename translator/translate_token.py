"""
sqlparse taken wrapper
"""
from typing import Callable
from sqlparse import tokens
from sqlparse.sql import Comparison, Function, Case, Identifier, IdentifierList, Statement, Token
...
class TranslateToken:
    ...
    def translate(self, cb_sql_dialect_rules: Callable[['TranslateToken'], None]) -> str:
        """
        Translate a token (with all its children) using a callback function
    ...
    def is_identifierList(self):
        return isinstance(self._token, IdentifierList)

    def is_case(self):
        return isinstance(self._token, Case) or isinstance(self._token.parent, Case)
